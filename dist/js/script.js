...
window.addEventListener('DOMContentLoaded', function () {
  ...
  function startGame() {
    ...
    var interval = setInterval(function () {
      var time = parseFloat(timeText.textContent);
  ...
  function renderBox() {
    ...
    box.style.height = box.style.width = "".concat(boxSize, "px");
    box.style.position = 'absolute';
    box.style.background = "rgb(".concat(getRandomColor(), ", ").concat(getRandomColor(), ", ").concat(getRandomColor(), ")");
    box.style.top = "".concat(getRandom(0, maxTop), "px");
    box.style.left = "".concat(getRandom(0, maxLeft), "px");
